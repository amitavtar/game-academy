                    ...
                    <div className="slick-slider ProgramSlider slick-initialized">
                        <div className="slick-list">
                            <div className="slick-track" style={{ width: '1296px', opacity: 1, transform: 'translate3d(0px, 0px, 0px)' }}>
                                <div data-index="0" className="slick-slide slick-active slick-current" tabindex="-1" aria-hidden="false"style={{ outline: 'none', width: '324px' }}>
                                    <div>
                                ...
                                <div data-index="1" className="slick-slide slick-active" tabindex="-1" aria-hidden="false"style={{ outline: 'none', width: '324px' }}>
                                    <div>
                                        <div tabindex="-1" style={{ width: '100%', display: 'inline-block' }}>
                                            <div className="text-center cursor-pointer whyChooseBox">
                                                <div className="eventGridFlex">
                                ...
                                <div data-index="2" className="slick-slide slick-active" tabindex="-1" aria-hidden="false"style={{ outline: 'none', width: '324px' }}>
                                    <div>
                                        <div tabindex="-1" style={{ width: '100%', display: 'inline-block' }}>
                                            <div className="text-center cursor-pointer whyChooseBox">
                                                <div className="eventGridFlex">
                                ...
                                <div data-index="3" className="slick-slide slick-active" tabindex="-1" aria-hidden="false"style={{ outline: 'none', width: '324px' }}>
                                    <div>
                                        <div tabindex="-1" style={{ width: '100%', display: 'inline-block' }}>
                                            <div className="text-center cursor-pointer whyChooseBox">
                                                <div className="eventGridFlex">
